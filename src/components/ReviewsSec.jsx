...
const ReviewsSec = () => {
    ...
    return (
        <section className="py-12 sm:py-12 lg:py-[67px] xl:pb-11">
            <div className="container max-w-[1295px] relative md:px-20">
                ...
                <div className="mt-6 sm:mt-10 md:mt-14 lg:mt-[52px] relative">
                    <Swiper ref={sliderRef} spaceBetween={27} modules={[Virtual]} slidesPerView={1} loop={true}
                        ...
                        {reviewSecData.map((item, index) => (
                            <SwiperSlide key={index} className="p-[22px] duration-300 my-6 border border-black border-opacity-10 rounded-md2 hover:border-orangeRed hover:border-opacity-10 hover:shadow-2xl">
